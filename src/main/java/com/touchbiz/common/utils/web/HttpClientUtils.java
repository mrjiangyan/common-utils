...
//    }
//
//    public static String invokeGet(String url, Map<String, Object> headers, Map params) {
//        return invokeGet(url, headers, params, DEFAULT_CONN_TIMEOUT, DEFAULT_SO_TIMEOUT);
//    }
//
//
//    /**
...
//     * @return
//     */
//    public static String invokeGet(String url, Map<String, Object> headers, Map params, int connectTimeout, int readTimeout) {
...
//
//        responseString = doRequest(httpGet, headers);
...
//     * @return
//     */
//    public static String invokePost(String requestUrl, Map<String, Object> headers, Map<String, Object> params, int connectTimeout, int readTimeout, boolean isJson) {
//
//        RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(readTimeout).setConnectTimeout(connectTimeout).setConnectionRequestTimeout(connectTimeout).build();
//        String responseString;
...
//        responseString = doRequest(httpPost, headers);
//        return responseString;
//    }
//
//    public static String invokePost(String requestUrl, Map<String, Object> headers, Map<String, Object> params) {
//        return invokePost(requestUrl, headers, params, DEFAULT_CONN_TIMEOUT, DEFAULT_SO_TIMEOUT, true);
//    }
//
//    public static String invokePostFormData(String requestUrl, Map<String, Object> headers, Map<String, Object> params) {
//        return invokePost(requestUrl, headers, params, DEFAULT_CONN_TIMEOUT, DEFAULT_SO_TIMEOUT, false);
//    }
//
//    public static String invokePost(String requestUrl, Map<String, Object> headers) {
//        return invokePost(requestUrl, headers, null);
//    }
//
//
//    /**
...
//     * @return
//     */
//    public static String invokePostByJson(String requestUrl, Map<String, Object> headers, String json, int connectTimeout, int readTimeout) {
//        RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(readTimeout).setConnectTimeout(connectTimeout).setConnectionRequestTimeout(connectTimeout).build();
//        String responseString;
//        HttpPost httpPost = new HttpPost(requestUrl);
//        httpPost.setConfig(requestConfig);
...
//    }
//
//    public static String invokePostByJson(String requestUrl, Map<String, Object> headers, String json) {
//        return invokePostByJson(requestUrl, headers, json, DEFAULT_CONN_TIMEOUT, DEFAULT_SO_TIMEOUT);
//    }
//
//    public static String invokePostByJson(String requestUrl, String json) {
//        return invokePostByJson(requestUrl, null, json);
//    }
//
//
//    public static String doRequest(HttpRequestBase httpRequestBase, Map<String, Object> headers) {
